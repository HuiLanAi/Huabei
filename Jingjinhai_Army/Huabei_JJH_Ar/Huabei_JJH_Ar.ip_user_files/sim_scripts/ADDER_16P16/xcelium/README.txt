...
#
# Generated by export_simulation on Tue Feb 16 15:31:50 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './ADDER_16P16.sh' script.

./ADDER_16P16.sh -reset_run
...
./ADDER_16P16.sh -noclean_files

For more information on the script, please type './ADDER_16P16.sh -help'.
