...
#
# Generated by export_simulation on Fri Mar 05 09:28:18 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './A_MATRIX_BRAM.sh' script.

./A_MATRIX_BRAM.sh -reset_run
...
./A_MATRIX_BRAM.sh -noclean_files

For more information on the script, please type './A_MATRIX_BRAM.sh -help'.
