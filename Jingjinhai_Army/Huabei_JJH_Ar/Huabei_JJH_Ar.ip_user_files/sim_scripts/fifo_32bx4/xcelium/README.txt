...
#
# Generated by export_simulation on Tue Mar 02 20:37:14 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './fifo_32bx4.sh' script.

./fifo_32bx4.sh -reset_run
...
./fifo_32bx4.sh -noclean_files

For more information on the script, please type './fifo_32bx4.sh -help'.
