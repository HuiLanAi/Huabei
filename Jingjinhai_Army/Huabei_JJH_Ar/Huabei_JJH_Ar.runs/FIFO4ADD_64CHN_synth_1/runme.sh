...
HD_PWD='B:/wd/Huabei/Huabei/Jingjinhai_Army/Huabei_JJH_Ar/Huabei_JJH_Ar.runs/FIFO4ADD_64CHN_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO4ADD_64CHN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO4ADD_64CHN.tcl
