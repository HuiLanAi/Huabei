...
HD_PWD='B:/wd/Huabei/Huabei/Jingjinhai_Army/Huabei_JJH_Ar/Huabei_JJH_Ar.runs/MATRIX_ABC_ROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MATRIX_ABC_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MATRIX_ABC_ROM.tcl
