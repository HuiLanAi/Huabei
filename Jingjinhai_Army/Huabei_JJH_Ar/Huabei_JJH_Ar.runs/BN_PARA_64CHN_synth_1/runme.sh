...
HD_PWD='B:/wd/Huabei/Huabei/Jingjinhai_Army/Huabei_JJH_Ar/Huabei_JJH_Ar.runs/BN_PARA_64CHN_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BN_PARA_64CHN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BN_PARA_64CHN.tcl
